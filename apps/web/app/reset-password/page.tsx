...
function ResetPasswordCard({ children }: { children: React.ReactNode }) {
    return (
    ...
    return (
        <form className="mt-5" onSubmit={handleSubmit}>
            ...
            <button
                type="submit"
                disabled={loading}
                className="q-btn-primary mt-4 w-full rounded-md px-4 py-3 text-sm font-semibold disabled:opacity-60"
            >
...
export default function ResetPasswordPage() {
    return (
        <ResetPasswordCard>
            <Suspense fallback={<p className="mt-4 text-base text-[#6f819a]">Loading...</p>}>
                <ResetPasswordForm />
            </Suspense>
        </ResetPasswordCard>
    );
